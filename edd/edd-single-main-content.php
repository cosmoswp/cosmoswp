...
$main_content_grid = 'grid-9';
if (!is_array($edd_single_side_elements) || empty($edd_single_side_elements)) {
    $main_content_grid = 'grid-12';
}
...
while (have_posts()) : the_post();
    ...
    <div id="download-<?php the_ID(); ?>" <?php post_class(); ?>>
        <div class="grid-row cosmoswp-edd-single-grid-row">
            <div class="<?php echo esc_attr($main_content_grid); ?>">
