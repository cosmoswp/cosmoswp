...
/* Button Height*/
$scroll_top_icon_options  = cosmoswp_get_theme_options( 'scroll-top-icon-options' );
...
if ( ! empty( $desktop_icon_size ) ) {
	...
	if ( 'icon' === $scroll_top_icon_options ) {
