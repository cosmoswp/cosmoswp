...
if ( strpos( $footer_general_bx_shadow_css, 'px' ) !== false ) {
	$footer_general_bx_shadow_color = cosmoswp_ifset( $footer_general_border['box-shadow-color'] );
	$footer_general_bx_shadow       = $footer_general_bx_shadow_css . ' ' . $footer_general_bx_shadow_color;
...
if ( strpos( $footer_top_bx_shadow_css, 'px' ) !== false ) {
	$footer_top_bx_shadow_color = cosmoswp_ifset( $footer_top_border['box-shadow-color'] );
	$footer_top_bx_shadow       = $footer_top_bx_shadow_css . ' ' . $footer_top_bx_shadow_color;
...
if ( strpos( $footer_main_bx_shadow_css, 'px' ) !== false ) {
	$footer_main_bx_shadow_color = cosmoswp_ifset( $footer_main_border['box-shadow-color'] );
	$footer_main_bx_shadow       = $footer_main_bx_shadow_css . ' ' . $footer_main_bx_shadow_color;
...
if ( strpos( $footer_bottom_bx_shadow_css, 'px' ) !== false ) {
	$footer_bottom_bx_shadow_color = cosmoswp_ifset( $footer_bottom_border['box-shadow-color'] );
	$footer_bottom_bx_shadow       = $footer_bottom_bx_shadow_css . ' ' . $footer_bottom_bx_shadow_color;
...
if ( 'custom' === $footer_sidebar1_widget_opt ) {
	/* margin */
...
if ( 'custom' === $footer_sidebar5_widget_opt ) {
	/*Footer sidebar-5*/
	$footer_sidebar5_css         = '';
...
if ( 'custom' === $footer_sidebar7_widget_opt  ) {
	/*Footer sidebar-7*/
	$footer_sidebar7_css         = '';
